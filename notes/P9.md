...
{% include figure.html src="Kliky.png" caption="" %}
...
public static void main(String[] args) {
    ...
    UndirectedGraph g = readUndirectedGraph(scanner, GraphImplementation.MATRIX);
...
{% include figure.html src="Graf6.png" caption="" %}
...
{% include figure.html src="Graf9.png" caption="" %}
...
{% include figure.html src="Graf10.png" caption="" %}
...
{% include figure.html src="Graf11.png" caption="" %}
...
obsahuje teda sled *v<sub>0</sub>*,...,*v<sub>n</sub>* taký, že *n ≥ 1* a *v<sub>n</sub> = v<sub>0</sub>*. Za účelom sporu
