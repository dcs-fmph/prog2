...
prednášky](./P5.html) *zostupné*
triedenie zoznamu celých čísel pomocou metódy
[`Collections.sort`](https://docs.oracle.com/en/java/javase/25/docs/api/java.base/java/util/Collections.html#sort(java.util.List,java.util.Comparator)), ktorá ako druhý parameter berie *komparátor*, čiže
inštanciu nejakej triedy implementujúcej rozhranie [`Comparator<? super
Integer>`](https://docs.oracle.com/en/java/javase/25/docs/api/java.base/java/util/Comparator.html).
...
[`compare`](https://docs.oracle.com/en/java/javase/25/docs/api/java.base/java/util/Comparator.html#compare(T,T)). Toto rozhranie síce definuje niekoľko ďalších statických
...
Rozhranie
[`Iterable<T>`](https://docs.oracle.com/en/java/javase/25/docs/api/java.base/java/lang/Iterable.html)
deklaruje okrem iného aj metódu
[`forEach`](https://docs.oracle.com/en/java/javase/25/docs/api/java.base/java/lang/Iterable.html#forEach(java.util.function.Consumer)),
...
[`Consumer<T>`](https://docs.oracle.com/en/java/javase/25/docs/api/java.base/java/util/function/Consumer.html)
z balíka `java.util.function`. V ňom je deklarovaná jediná abstraktná
metóda
[`accept`](https://docs.oracle.com/en/java/javase/25/docs/api/java.base/java/util/function/Consumer.html#accept(T))
...
a podobne).
  ...
  - [Dokumentácia k JavaFX 25 API](https://openjfx.io/javadoc/25/).
...
{% include figure.html src="Okno1.png" caption="Okno zobrazené po spustení aplikácie" width="300px" %}
</div>
``` java
...
Uvedený kód si teraz rozoberme:
  ...
  - Hlavná trieda JavaFX aplikácie (tzn. trieda obsahujúca metódu
    ...
    [`Application`](https://openjfx.io/javadoc/25/javafx.graphics/javafx/application/Application.html)
  ...
  - Každá trieda dediaca od triedy `Application` musí implementovať jej
    ...
    `primaryStage` typu
    [`Stage`](https://openjfx.io/javadoc/25/javafx.graphics/javafx/stage/Stage.html)
      ...
      - Zvyšnými riadkami už len hovoríme, že „obsahom” hlavného okna má
        byť prázdna oblasť o veľkosti 300 krát 250 pixelov:
          - Kontajnerom pre obsah okna je inštancia triedy
            [`Scene`](https://openjfx.io/javadoc/25/javafx.graphics/javafx/scene/Scene.html).
          ...
          - Volaním konštruktora `Pane pane = new Pane()` vytvoríme novú
            ...
            [`Pane`](https://openjfx.io/javadoc/25/javafx.graphics/javafx/scene/layout/Pane.html)
...
<div class="float-right">
{% include figure.html src="Okno2.png" caption="Hlavné okno výslednej aplikácie" width="300px" %}
</div>
...
[`Label`](https://openjfx.io/javadoc/25/javafx.controls/javafx/scene/control/Label.html),
...
[`ActionEvent`](https://openjfx.io/javadoc/25/javafx.base/javafx/event/ActionEvent.html).
Udalosť je teda akýsi objekt nesúci informáciu o tom, že bolo stlačené
dané tlačidlo. Každé tlačidlo – objekt typu
[`Button`](https://openjfx.io/javadoc/25/javafx.controls/javafx/scene/control/Button.html)
...
rozhranie
[`EventHandler`](https://openjfx.io/javadoc/25/javafx.base/javafx/event/EventHandler.html)`<ActionEvent>`,
...
[`Circle`](https://openjfx.io/javadoc/25/javafx.graphics/javafx/scene/shape/Circle.html),
[`Rectangle`](https://openjfx.io/javadoc/25/javafx.graphics/javafx/scene/shape/Rectangle.html),
[`Arc`](https://openjfx.io/javadoc/25/javafx.graphics/javafx/scene/shape/Arc.html),
[`Ellipse`](https://openjfx.io/javadoc/25/javafx.graphics/javafx/scene/shape/Ellipse.html),
[`Line`](https://openjfx.io/javadoc/25/javafx.graphics/javafx/scene/shape/Line.html),
[`Polygon`](https://openjfx.io/javadoc/25/javafx.graphics/javafx/scene/shape/Polygon.html),
atď. Všetky útvary dedia od spoločnej abstraktnej nadtriedy
[`Shape`](https://openjfx.io/javadoc/25/javafx.graphics/javafx/scene/shape/Shape.html).
...
udalosť typu
[`MouseEvent`](https://openjfx.io/javadoc/25/javafx.graphics/javafx/scene/input/MouseEvent.html)
...
<div class="float-right">
{% include figure.html src="Okno3.png" caption="Výsledná aplikácia" width="360px" %}
</div>
...
## Odkazy
  ...
  - [Dokumentácia k JavaFX](https://openjfx.io/javadoc/25/)
