...
[`Menu`](https://openjfx.io/javadoc/25/javafx.controls/javafx/scene/control/Menu.html),
[`RadioButton`](https://openjfx.io/javadoc/25/javafx.controls/javafx/scene/control/RadioButton.html),
či
[`ListView<T>`](https://openjfx.io/javadoc/25/javafx.controls/javafx/scene/control/ListView.html))
a štandardných dialógov
([`Alert`](https://openjfx.io/javadoc/25/javafx.controls/javafx/scene/control/Alert.html)
resp.
[`FileChooser`](https://openjfx.io/javadoc/25/javafx.graphics/javafx/stage/FileChooser.html)),
...
názov
[`TextArea`](https://openjfx.io/javadoc/25/javafx.controls/javafx/scene/control/TextArea.html)
...
rozhranie
[`Property<T>`](https://openjfx.io/javadoc/25/javafx.base/javafx/beans/property/Property.html)
a možno si ju predstaviť ako „značne pokročilý obal pre nejakú hodnotu
typu `T`”. Rozhranie `Property<T>` je rozšírením rozhrania
[`ObservableValue<T>`](https://openjfx.io/javadoc/25/javafx.base/javafx/beans/value/ObservableValue.html)
...
[`ChangeListener<T>`](https://openjfx.io/javadoc/25/javafx.base/javafx/beans/value/ChangeListener.html).
...
[`StringProperty`](https://openjfx.io/javadoc/25/javafx.base/javafx/beans/property/StringProperty.html)
...
JavaFX ich do aplikácie možno pridať nasledujúcim spôsobom:
  ...
  - Do hlavného okna aplikácie sa umiestní ovládací prvok typu
    [`MenuBar`](https://openjfx.io/javadoc/25/javafx.controls/javafx/scene/control/MenuBar.html),
  ...
  - Položka ponuky je reprezentovaná inštanciou triedy
    [`MenuItem`](https://openjfx.io/javadoc/25/javafx.controls/javafx/scene/control/MenuItem.html).
  ...
  - Špeciálne položky ponúk sú reprezentované inštanciami tried
    [`CheckMenuItem`](https://openjfx.io/javadoc/25/javafx.controls/javafx/scene/control/CheckMenuItem.html)
    (takúto položku ponuky možno zvolením zaškrtnúť resp. odškrtnúť) a
    [`SeparatorMenuItem`](https://openjfx.io/javadoc/25/javafx.controls/javafx/scene/control/SeparatorMenuItem.html)
...
inštancie triedy
[`ContextMenu`](https://openjfx.io/javadoc/25/javafx.controls/javafx/scene/control/ContextMenu.html).
...
```
  ...
  - Previazanie vlastností možno využiť aj v rôzličných ďalších
    ...
    [`Bindings`](https://openjfx.io/javadoc/25/javafx.base/javafx/beans/binding/Bindings.html).
...
[`TextInputDialog`](https://openjfx.io/javadoc/25/javafx.controls/javafx/scene/control/TextInputDialog.html)
alebo
[`ChoiceDialog`](https://openjfx.io/javadoc/25/javafx.controls/javafx/scene/control/ChoiceDialog.html).
