...
{% include figure.html src="Textovyeditor4.png" caption="Možný vzhľad otváracieho dialógu typu `FileChooser`." width="500px" %}
...
triedy
[`Font`](https://openjfx.io/javadoc/25/javafx.graphics/javafx/scene/text/Font.html),
...
{% include figure.html src="Textovyeditor5.png" caption="Výsledný vzhľad dialógového okna." width="420px" %}
</div>
...
nestretli:
  ...
  - Z jedného „zoznamu” typu
    ...
    [`MultipleSelectionModel<T>`](https://openjfx.io/javadoc/25/javafx.controls/javafx/scene/control/MultipleSelectionModel.html),
...
[`ToggleGroup`](https://openjfx.io/javadoc/25/javafx.controls/javafx/scene/control/ToggleGroup.html).
...
### Cvičenia
  ...
  - Rozšírte textový editor o možnosť nastavovania farby fontu a farby
    ...
    [`ColorPicker`](https://openjfx.io/javadoc/25/javafx.controls/javafx/scene/control/ColorPicker.html).
