...
{% include figure.html src="Collections.png" caption="" %}
...
[`Collection<E>`](https://docs.oracle.com/en/java/javase/25/docs/api/java.base/java/util/Collection.html).
...
v rozhraní `Collection<E>` patria nasledujúce:
  ...
  - Metóda `boolean add​(E e)` pridá inštanciu `e` typu `E` do
    ...
    vykonaní tejto operácie bolo dané zoskupenie zmenené (napríklad pri
    zoznamoch by to tak malo byť vždy; naopak množina sa nezmení v
    prípade, že je do nej pridaný prvok, ktorý už obsahuje). Pri
    jednotlivých implementáciách rozhrania `Collection<E>` môže byť
    správanie tejto metódy bližšie určené: napríklad pri zoznamoch sa
...
[`List<E>`](https://docs.oracle.com/en/java/javase/25/docs/api/java.base/java/util/List.html).
...
Dvoma najdôležitejšími triedami implementujúcimi rozhranie `List<E>` sú:
  ...
  - Trieda
    [`ArrayList<E>`](https://docs.oracle.com/en/java/javase/25/docs/api/java.base/java/util/ArrayList.html)
  ...
  - Trieda
    [`LinkedList<E>`](https://docs.oracle.com/en/java/javase/25/docs/api/java.base/java/util/LinkedList.html)
...
### Rad a objostranný rad
  ...
  - Trieda `LinkedList<E>` okrem rozhrania `List<E>` implementuje aj
    rozhranie
    [`Queue<E>`](https://docs.oracle.com/en/java/javase/25/docs/api/java.base/java/util/Queue.html)
  ...
  - Okrem toho trieda `LinkedList<E>` implementuje aj rozhranie
    [`Deque<E>`](https://docs.oracle.com/en/java/javase/25/docs/api/java.base/java/util/Deque.html)
...
[`Set<E>`](https://docs.oracle.com/en/java/javase/25/docs/api/java.base/java/util/Set.html)
...
[`HashSet<E>`](https://docs.oracle.com/en/java/javase/25/docs/api/java.base/java/util/HashSet.html):
...
rozhranie
[`Iterable<E>`](https://docs.oracle.com/en/java/javase/25/docs/api/java.base/java/lang/Iterable.html).
...
[`Iterator<E>`](https://docs.oracle.com/en/java/javase/25/docs/api/java.base/java/util/Iterator.html).
...
{% include figure.html src="Iterator.png" caption="" %}
...
rozhranie
[`ListIterator<E>`](https://docs.oracle.com/en/java/javase/25/docs/api/java.base/java/util/ListIterator.html).
...
Rozhranie [`Map<K,
V>`](https://docs.oracle.com/en/java/javase/25/docs/api/java.base/java/util/Map.html)
...
[`HashMap<K,
V>`](https://docs.oracle.com/en/java/javase/25/docs/api/java.base/java/util/HashMap.html)
...
[`SortedSet<E>`](https://docs.oracle.com/en/java/javase/25/docs/api/java.base/java/util/SortedSet.html)
resp. [`SortedMap<K,
V>`](https://docs.oracle.com/en/java/javase/25/docs/api/java.base/java/util/SortedMap.html)
...
triedy
[`TreeSet<E>`](https://docs.oracle.com/en/java/javase/25/docs/api/java.base/java/util/TreeSet.html)
resp. [`TreeMap<K,
V>`](https://docs.oracle.com/en/java/javase/25/docs/api/java.base/java/util/TreeMap.html).
  ...
  - V základnom variante – to jest pri použití konštruktora triedy
    ...
    [`Comparable<E>`](https://docs.oracle.com/en/java/javase/25/docs/api/java.base/java/lang/Comparable.html)
...
[`Comparator<T>`](https://docs.oracle.com/en/java/javase/25/docs/api/java.base/java/util/Comparator.html).
