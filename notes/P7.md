...
{% include figure.html src="Sled_cesta.png" caption="" %}
...
relácie. To znamená, že každé dva vrcholy z rovnakého komponentu
...
{% include figure.html src="Graf3.png" caption="" %}
...
{% include figure.html src="Graf4.png" caption="" %} {% include figure.html src="Graf4DFS.png" caption="" %} {% include figure.html src="DFSTree.png" caption="" %}

*Strom prehľadávania do šírky:*

{% include figure.html src="Graf4.png" caption="" %} {% include figure.html src="Graf4BFS.png" caption="" %} {% include figure.html src="BFSTree.png" caption="" %}
...
{% include figure.html src="Graf5.png" caption="" %}
</div>
*Príklad*. Pre orientovaný graf s
